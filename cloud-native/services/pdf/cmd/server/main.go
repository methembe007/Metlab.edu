...
import (
	...
	"github.com/metlab/pdf/internal/config"
	"github.com/metlab/pdf/internal/handler"
...
func main() {
	...
	appLogger.Info("Starting PDF Service", map[string]interface{}{
		"port":        cfg.Port,
	...
	pb.RegisterPDFServiceServer(grpcServer, pdfHandler)
	...
	appLogger.Info("PDF service listening", map[string]interface{}{
